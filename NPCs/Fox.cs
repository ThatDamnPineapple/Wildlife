...
namespace Wildlife.NPCs
{
    public class Fox : ModNPC
    {
				...
				public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            return spawnInfo.player.ZoneOverworldHeight && !spawnInfo.invasion && !spawnInfo.sky && !Main.eclipse && !spawnInfo.player.ZoneDesert && !spawnInfo.player.ZoneJungle ? 0.08f : 0f;
		}
